...
- [MountARPagePayload](../interfaces/mimeeqApp._mimeeq.MountARPagePayload.md)
- [MountConfiguratorPayload](../interfaces/mimeeqApp._mimeeq.MountConfiguratorPayload.md)
- [MountFavouritesPayload](../interfaces/mimeeqApp._mimeeq.MountFavouritesPayload.md)
- [MountListPayload](../interfaces/mimeeqApp._mimeeq.MountListPayload.md)
...
Ƭ **OnLoginSuccess**: (`user`: [`UserData`](../interfaces/mimeeqApp._mimeeq.UserData.md)) => `void`
...
| Name | Type |
| :------ | :------ |
| `user` | [`UserData`](../interfaces/mimeeqApp._mimeeq.UserData.md) |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `extension?` | `string` | Extension of file. Based on that image has set proper MimeType. Accepts only png, jpg and jpeg. |
| `size?` | `number` | Width of image. Height will be set automatically based on canvas aspect ratio. On iOS powered mobiles it may cause reloads if size is bigger than 2k. We recommend 1k for ecommerce. |
| `backgroundColor?` | `string` | If provided, will be used for background on jpeg file. Accepts only hex and hexa format. |
